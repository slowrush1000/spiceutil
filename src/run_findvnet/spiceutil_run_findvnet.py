...
class Findvnet(run.Run):
    ...
    def findvnet(self):
        self.get_input().get_log().get_logger().info(f"# findvnet start ... {datetime.datetime.now()}")
        ...
        #
        self.get_input().get_log().get_logger().info(f"# findvnet end ... {datetime.datetime.now()}")
